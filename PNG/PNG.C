...
png_get_copyright(png_const_structp png_ptr)
{
   ...
   return PNG_STRING_NEWLINE \
     "libpng version 1.5.20" PNG_STRING_NEWLINE \
...
{
   int ret = 1;
   unsigned long xy_hi,yx_hi,xy_lo,yx_lo;
...
int PNGAPI png_xy_from_XYZ(png_xy *xy, png_XYZ XYZ)
{
...
int PNGAPI png_XYZ_from_xy(png_XYZ *XYZ, png_xy xy)
{
...
int PNGAPI png_XYZ_from_xy_checked(png_structp png_ptr, png_XYZ *XYZ, png_xy xy)
{
   PNG_UNUSED(png_ptr)
   ...
   int filter_type)
{
   ...
   PNG_UNUSED(width)
   PNG_UNUSED(height)
   PNG_UNUSED(bit_depth)
   PNG_UNUSED(color_type)
   PNG_UNUSED(interlace_type)
   PNG_UNUSED(compression_type)
   PNG_UNUSED(filter_type)
}
