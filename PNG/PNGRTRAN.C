   ...
   png_fixed_point output_gamma)
{
   ...
   if (compose != 0)
   {
      ...
      png_ptr->background_gamma = png_ptr->gamma;
...
png_do_unpack(png_row_infop row_info, png_bytep row)
{
   ...
   if (row_info->bit_depth < 8)
   {
      ...
      row_info->rowbytes = (png_size_t)(row_width * row_info->channels);
   }
}
#endif
      ...
      if (row_info->bit_depth == 8)
      {
         if (flags & PNG_FLAG_FILLER_AFTER)
         {
            ...
            *(--dp) = lo_filler;
            ...
            row_info->rowbytes = (png_size_t)(row_width * 2);
         }
      ...
      else if (row_info->bit_depth == 16)
      {
         if (flags & PNG_FLAG_FILLER_AFTER)
         {
            ...
            *(--dp) = hi_filler;
            ...
            row_info->rowbytes = (png_size_t)(row_width * 4);
         }
      ...
      else if (row_info->bit_depth == 16)
      {
         if (flags & PNG_FLAG_FILLER_AFTER)
         {
            ...
            *(--dp) = hi_filler;
            ...
            row_info->rowbytes = (png_size_t)(row_width * 8);
         }
   ...
   png_const_colorp palette, png_const_bytep trans_alpha, int num_trans)
{
   ...
   if (row_info->color_type == PNG_COLOR_TYPE_PALETTE)
   {
      if (row_info->bit_depth < 8)
      {
         ...
         row_info->rowbytes = (png_size_t)(row_width);
      }
      ...
      {
         {
            ...
            else
            {
               ...
               row_info->rowbytes = (png_size_t)(row_width * 3);
