...
TIFFOpen(const char* name, const char* mode)
{
	...
	switch(m) {
		...
		case _O_RDWR|_O_CREAT:		dwMode = OPEN_ALWAYS;   break;
		case _O_RDWR|_O_TRUNC:		dwMode = CREATE_ALWAYS; break;
		case _O_RDWR|_O_CREAT|_O_TRUNC:	dwMode = CREATE_ALWAYS; break;
